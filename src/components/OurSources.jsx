    ...
    return(
        ...
        <div className="m-4">
            ...
            <div className="flex justify-between mx-8 px-15">
                <img className="hover:scale-130" src="src/assets/x.svg" alt="" />
                <img className="hover:scale-150" src="src/assets/youtube.svg" alt="" />
                <img className="hover:scale-130" src="src/assets/bbc.svg" alt="" />
                <img className="hover:scale-130" src="src/assets/NYT.svg" alt="" />
            </div>
        </div>
        </>
    )
