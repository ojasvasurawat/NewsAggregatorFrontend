        ...
        <>
            <div className="flex flex-col md:flex-row items-center bg-gradient-to-tr from-blue-100 via-indigo-300 to-purple-200  rounded-2xl shadow-lg overflow-hidden p-6 md:p-8 max-w-5xl mx-auto">
                ...
                <div className="text-left md:text-justify space-y-4">
                    ...
                    <button className="mt-4 inline-block text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 font-semibold rounded-lg text-sm px-6 py-2 transition duration-300 shadow-md hover:shadow-blue-200">{text3}</button>
                </div>
            </div>
        </>
    )
