    ...
    return (<>
        <div className="mb-5">
            <div className="text-center text-gray-800 mx-90">
                <h1 className="text-4xl text-black my-3.5 mb-6">News & Insights: Stay Informed with the Latest Trends</h1>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-6 px-4 md:px-10">
                <Card3
