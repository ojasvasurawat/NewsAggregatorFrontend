...
export default function SignInCard() {
    ...
    return (<>
        <div className="m-40">
            ...
            <div>
                <p>Email Address</p>
                <input className="border-2 p-2 border-neutral-300 w-full rounded-lg" type="text" placeholder="Enter your email" />
            </div>
            <div className="flex justify-between pt-4">
                <p>Password</p>
                <h1>Forgot password</h1>
            </div>
            <input className="border-2 p-2 border-neutral-300 w-full rounded-lg" type="text" placeholder="Enter your password" />
            <div className="pt-4">
                <input className="" type="checkbox" />
                <span className="p-1">Stay signed in</span>
            </div>
            <div className="pt-4">
                <button onClick={() => navigate("/home")} className="bg-black font-bold p-2 text-white rounded-xl hover:scale-105 duration-400 w-full">
                    Login
                </button>
            </div>
