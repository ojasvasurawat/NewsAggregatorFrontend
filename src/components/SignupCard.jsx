    ...
    return (<>
        <div className="m-20 px-20 bg-white">
            ...
            <div className="flex justify-between mt-10 mb-2">
                <button className="border-2 rounded-xl p-2 flex hover:scale-110 shadow-lg"><img src="src/assets/icons8-google 1.svg" className="pr-1"></img>Sign in with Google</button>
                <button className="border-2 rounded-xl p-2 flex hover:scale-110 shadow-lg"><img src="src/assets/apple.svg" className="pr-1"></img>Sign in with Apple</button>
            </div>
