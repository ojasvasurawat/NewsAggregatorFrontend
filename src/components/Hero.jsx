    ...
    return (<>
        <div className="p-5 flex justify-between bg-gray-100 rounded-lg">
            <div className="m-9">
                ...
                <button onClick={()=>navigate("/signup")} className="m-3 focus:outline-none text-gray-200 bg-black hover:border hover:border-slate-300 hover:bg-black hover:text-slate-300 hover:bg- focus:ring-2 focus:ring-slate-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-balck dark:focus:ring-gray-200 ease-linear">Get Started</button>
            </div>
            <div className="m-5">
