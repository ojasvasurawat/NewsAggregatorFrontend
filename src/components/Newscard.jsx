export default function Newscard({text1,text2,text3,text4,image}) {
    return (
        <div className="p-3 m-4 text-white hover:scale-105 hover:bg-black hover:shadow-lg hover:rounded-lg  duration-500 flex flex-col shadow-lg active:scale-105 active:bg-black active:shadow-lg active:rounded-lg active:text-active
...
>
            <div className="p-3 justify-items-center mt-3 "><img className="" src={image}/></div>
            <div>
                <div className="p-3">
